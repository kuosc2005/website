	...
	return (
		<>
			<div className={"container banner"}>
				...
				<p>
				Kathmandu University Open Source Community (KUOSC) is the Open Source related wing of KUCC. It is a vibrant historic community from Kathmandu University which provides a common platform for all FOSS enthusiasts to discuss, share, and learn about free and open source softwares.
